...
do
    if [ ! -f "PairSpecSim_${i}_${NumEvents}_${Egamma_start}_${Egamma_end}/EICReconOut_${i}_${NumEvents}.root" ]; then
	echo "PairSpecSim_${i}_${NumEvents}_${Egamma_start}_${Egamma_end}/EICReconOut_${i}_${NumEvents}.root not found!"
